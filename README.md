...
## Repository Content
### Data
* The file [final_dataset.csv](https://github.com/lujainibrahim/llm-roleplaying/blob/main/data/final_dataset.csv) in the `data` folder is the final processed dataset that is used in the analyses.
